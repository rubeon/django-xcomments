from xcomments.models import Comment, FreeComment
from xcomments.views.comments import PublicFreeCommentForm
from xcomments.models import PHOTOS_REQUIRED, PHOTOS_OPTIONAL, RATINGS_REQUIRED, RATINGS_OPTIONAL, IS_PUBLIC
from xcomments.models import MIN_PHOTO_DIMENSION, MAX_PHOTO_DIMENSION
...
COMMENT_FORM = 'xcomments/form.html'
FREE_COMMENT_FORM = 'xcomments/freeform.html'
...
class CommentFormNode(template.Node):
    ...
    def render(self, context):
        ...
        if self.free:
            ...
            context['gonzo']=context['hash']
            f = PublicFreeCommentForm(context)
